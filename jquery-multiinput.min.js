(function(g){var k=0,h=[],m=[],n=[],e=null,s=["pointer","mouse","touch"],r=["start","move","end","enter","leave"],p={start:"pointerdown mousedown touchstart",move:"pointermove mousemove touchmove",end:"pointerup mouseup touchend",enter:"pointerenter mouseenter touchenter",leave:"pointerleave mouseleave touchleave"},t=function(c,d,a,b){var f=function(a,b,c,d){var f,q="multi"+b,h=g(a);return function(a){a.multiType=q;f=s.filter(function(b){return~a.type.indexOf(b)});if(e!==f[0]){if(("touch"===e||"pointer"===
e)&&"mouse"===f[0]||"pointer"===e&&"touch"===f[0])return;if(null!==e){e=f[0];return}e=f[0]}return null===c?(a.multiType=q,h.triggerHandler(q,[a,d])):h.find(a.target).trigger(q,[a,d])}}(c,d,a,k);n[k]=f;h[k]=b;if(null===a)g(c).on(p[d],f);else g(c).on(p[d],a,f);return k++},u=g.fn.on;g.fn.on=function(c,d,a,b,f){switch(c){case "multistart":case "multimove":case "multiend":case "multienter":case "multileave":if("undefined"===typeof d)break;var l,g,e,k=r.filter(function(a){return~c.indexOf(a)});e=function(a,
b,c){if(g===h[c])return b.multiType=a.type,g.apply(this,[b])};if("function"===typeof d)l=null,g=d,d=e;else if("function"===typeof a)l=d,g=a,a=e;else throw Error("\u5f15\u6570\u304c\u4e0d\u6b63\u3060\u3088\u3063");l=t(this,k[0],l,g);m[l]=e}return u.apply(this,[c,d,a,b,f])};var v=g.fn.off;g.fn.off=function(c,d,a){switch(c){case "multistart":case "multimove":case "multiend":case "multienter":case "multileave":var b,f,e;if("function"===typeof d){b=h.indexOf(d);if(0>b)break;d=m[b];e=n[b];f=r.filter(function(a){return~c.indexOf(a)});
g(this).off(p[f[0]],e)}else if("function"===typeof a){b=h.indexOf(a);if(0>b)break;a=m[b];e=n[b];f=r.filter(function(a){return~c.indexOf(a)});g(this).off(p[f[0]],e)}"function"===typeof e&&(delete h[b],delete m[b],delete n[b])}return v.apply(this,[c,d,a])};g.fn.getMultiXY=function(c,d){var a={};if(!c)return a;d=d||{};d.target=isNaN(d.target)?0:Math.max(0,Math.min(d.target-0,2));var b=["changedTouches","targetTouches","touches"][d.target];switch(c.type){case "mousedown":case "mousemove":case "mouseup":case "mouseenter":case "mouseleave":case "pointerdown":case "pointermove":case "pointerup":case "pointerenter":case "pointerleave":a.screenX=
